...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes('pages', '--div--;SZ Pagesettings, tx_szpagesettings_hideFooterDesc, tx_szpagesettings_footerDesc;;;richtext:rte_transform[flag=rte_enabled|mode=ts], tx_szpagesettings_productImgFal, tx_szpagesettings_productImg, tx_szpagesettings_productCancelled, tx_szpagesettings_productZone, tx_szpagesettings_productDivision,--div--;SZ Teaser;,tx_szpagesettings_teaserHeadline, tx_szpagesettings_teaserTxt;;;richtext:rte_transform[flag=rte_enabled|mode=ts], tx_szpagesettings_teaserImgFal, tx_szpagesettings_teaserImg, tx_szpagesettings_teaserLink, tx_szpagesettings_teaserLinktxt,tx_szpagesettings_pageIcon');
